...
nuke.menu('Nodes').addCommand('Merge/Merges/MergeUnion', 'nuke.createNode("Merge2", "bbox union", inpanel=False)', 'meta+m', shortcutContext=2)
...
nuke.menu('Nodes').addCommand('Merge/Merges/Minus', 'nuke.createNode("Merge2", "operation minus output rgb", inpanel=False)', 'alt+meta+n', shortcutContext=2)
...
nuke.menu('Nodes').addCommand('Merge/Merges/MergeAlpha', 'nuke.createNode("Merge2", "operation screen bbox union Achannels alpha Bchannels alpha output alpha", inpanel=False)', 'alt+meta+shift+n', shortcutContext=2)
nuke.menu('Nodes').addCommand('Merge/Merges/Screen', 'nuke.createNode("Merge2", "operation screen bbox union", inpanel=False)', 'alt+meta+n', shortcutContext=2)
...
# Re-assign rename shortcut
# nuke.menu('Nuke').addCommand('Edit/Node/Rename', '', 'alt+shift+k', shortcutContext=2)